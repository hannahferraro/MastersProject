...
Average Sediment Carbon Density over Time at Brewers Bay
...
Average Sediment Carbon Density over Time at Fortuna Bay
...
Average Sediment Carbon Density over Time at Lindbergh Bay
...
Average SCD over Time and Treatment

```{r}
#| echo: false
#| warning: false
#| message: false
# make sure TIME is categorical
sed2 <- sed |>
  mutate(TIME = factor(TIME))
